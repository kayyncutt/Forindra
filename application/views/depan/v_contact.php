                    ...
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <!-- <li class="nav-item">
                                  <a class="nav-link" href="<?php echo site_url('contact');?>">Registrasi</a>
                                </li> -->
                                <li class="nav-item">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="contact-address">
                                ...
                                <div class="contact-details">
                                    ...
                                    <h6>Alamat</h6>
                                    <p> Jl. Margonda Raya No.100, Pondok Cina, Kecamatan Beji, Kota Depok, Jawa Barat 16424
                                        <!-- <br> Albany, NY
                                        <br> USA. 11001</p> -->
                                    </div>
                                    <br>
