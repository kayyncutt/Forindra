        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>Organisasi Forindra</h1>
                            <h4>organisasi yang baik untuk mencapai tujuan<br>yang diinginkan secara optimal.</h4>
                            <!-- <div class="slider-btn">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>FORINDRA</h1>
                            <h4>Suatu perkumpulan nama Riyadi.<br> seindonesia untuk menambah persaudaraan.<br>agar lebih erat dan kuat.</h4>
                            <!-- <div class="slider-btn">
